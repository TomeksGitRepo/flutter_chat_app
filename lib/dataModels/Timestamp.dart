...
@immutable
@HiveType(typeId: 2)
class Timestamp extends cf.Timestamp {
  /// Creates a [Timestamp]
  Timestamp(
    this._seconds,
    this._nanoseconds,
  ) : super(_seconds, _nanoseconds) {
  ...
  @override
  String toString() =>
      'Timestamp(_seconds: $_seconds, _nanoseconds: $_nanoseconds)';
  ...
  factory Timestamp.fromJson(String source) =>
      Timestamp.fromMap(json.decode(source));
}
